...
const EditUserAdmin = () => {
  ...
  useEffect(() => {
    ...
    fetchDataFromApi(`/api/user/userAdmin/${id}`).then((res) => {
        console.log(res);
        setFormFields({
            name: res.data?.name,
            ...
            locationManageName: res.data?.locationManageName,
            locationManageId: res.data?.locationManageId,
            role: res.data?.role,
            password: "", // Không hiển thị mật khẩu cũ vì bảo mật
        });
      });
  }, []);
  ...
  return (
    <div className="right-content w-100">
      ...
      <form className="form" onSubmit={editUserAdmin}>
        <div className="row">
